          ...
          {sent ? (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mb-6">
                Jos sähköposti löytyy järjestelmästä, lähetimme sinulle
                salasanan vaihtolinkin. Tarkista myös roskapostikansio.
              </p>
              <Link
                href="/login"
            ...
            <>
              ...
              <p className="text-sm text-gray-500 mb-6">
                Syötä sähköpostiosoitteesi niin lähetämme sinulle salasanan
                vaihtolinkin.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  {loading ? "Lähetetään..." : "Lähetä vaihtolinkki"}
                </button>
              </form>
